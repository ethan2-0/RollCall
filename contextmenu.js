(function() {
    var menucss = "/*START MENU*/.menu {background-color: white;box-shadow: 0px 0px 1px 1px rgba(0, 0, 0, 0.1);position: absolute;left: 0px;top: 0px;}"
        + ".menuitem {padding-top: 4px;padding-bottom: 4px;padding-right: 8px;padding-left: 6px;cursor: pointer;font-size: 16px;transition: background-color"
        + " 0.4s;background-color: white;}.menuitem:hover {background-color: #EEE;}.menusep {width: 90%;margin-left: 5%;height: 1px;background-color: #EEE;}";
